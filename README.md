...
While the functional behavior remains unchanged from the non-OOP version, the primary focus of this implementation is clean architecture and separation of concerns.

🧱 Architectural Overview

The application follows a clear Controller–View–Domain structure, ensuring that each layer has a single, well-defined responsibility.
...
design, type annotations, and docstring conventions.

All implementation decisions and final code were written and reviewed by the
author.
